...
const TopRated = () => {
    ...
    useEffect(() => {
        const fetchTopRated = async () => {
            ...
            try {
                ...
                params.append('sortBy', filterState.sort || 'rating');
    ...
    return (
        <div className="top-rated-page" style={{ padding: '60px 0' }}>
            <Seo title="Top Rated – Highest Rated Drones & Electronics" description="Only products with 4+ star ratings from verified buyers. Shop top-rated drones, robotics and electronics at Janaki Sky Innovations." path="/top-rated" />
            <div className="container">
                <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginBottom: '60px' }}>
                    <div style={{ fontSize: '60px' }}>⭐</div>
                    <div>
                        <h1 style={{ fontSize: '48px', fontWeight: '800', marginBottom: '5px' }}>TOP RATED</h1>
                        <p style={{ fontSize: '18px', color: '#666' }}>Only products with 4.5+ star ratings from verified buyers.</p>
                    </div>
                </div>

                <div className="section-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px' }}>
                    <h3 style={{ fontSize: '24px', fontWeight: '800', color: '#333' }}>Highest Rated Items</h3>
